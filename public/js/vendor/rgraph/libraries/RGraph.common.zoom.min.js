...
{if(obj.Get('chart.zoom.mode')=='area'){var canvas=obj.canvas;var context=obj.context;obj.canvas.style.cursor='crosshair';RGraph.Register(obj);canvas.onmousedown=function(e)
{var canvas=e.target;var coords=RGraph.getMouseXY(e);var obj=canvas.__object__;if(RGraph.Registry.Get('chart.zoomed.area.div')){RGraph.Registry.Get('chart.zoomed.area.div').style.display='none';}
if(typeof(RGraph.Registry.Get('chart.zoomed.area.divs'))==null){RGraph.Registry.Set('chart.zoomed.area.divs',[]);}else{var divs=RGraph.Registry.Get('chart.zoomed.area.divs');if(divs&&divs.length){for(var i=0;i<divs.length;++i){if(divs[i]){divs[i].style.display='none';divs[i]=null;}}}}
...
{if(RGraph.Registry.Get('chart.mousedown')&&RGraph.Registry.Get('chart.button')==0){var div=RGraph.Registry.Get('chart.mousedown');var x=e.pageX-div.__offsetx__;var y=e.pageY-div.__offsety__;div.style.left=x+'px';div.style.top=y+'px';}else if(RGraph.Registry.Get('chart.mousedown')&&RGraph.Registry.Get('chart.button')==2){var img=RGraph.Registry.Get('chart.mousedown');var x=img.__originalx__+e.pageX-img.__startx__;var y=img.__originaly__+e.pageY-img.__starty__;img.style.left=x+'px';img.style.top=y+'px';}}
var divs=RGraph.Registry.Get('chart.zoomed.area.divs');if(typeof(divs)=='object'){divs.push(div);}else{RGraph.Registry.Set('chart.zoomed.area.divs',[div])}
...
{if(obj.Get('chart.zoom.mode')=='thumbnail'){RGraph.ZoomWindow(obj.canvas);}
if(obj.Get('chart.zoom.mode')=='area'){RGraph.ZoomArea(obj);}}
RGraph.ZoomWindow=function(canvas)
{ZoomWindow_mousemove=function(e)
{e=RGraph.FixEventObject(e);var obj=e.target.__object__;var canvas=obj.canvas;var context=obj.context;var coords=RGraph.getMouseXY(e);if(!RGraph.Registry.Get('chart.zoomed.div')){var div=document.createElement('div');div.className='RGraph_zoom_window';div.style.width=obj.Get('chart.zoom.thumbnail.width')+'px';div.style.height=obj.Get('chart.zoom.thumbnail.height')+'px';div.style.position='absolute';div.style.overflow='hidden';div.style.backgroundColor='white';div.style.left='-1000px';div.style.top='-1000px';div.style.borderRadius=div.style.MozBorderRadius=div.style.WebkitBorderRadius='5px';if(obj.Get('chart.zoom.shadow')){div.style.boxShadow=div.style.MozBoxShadow=div.style.WebkitBoxShadow='rgba(0,0,0,0.5) 0 0 15px';}
div.__object__=obj;document.body.appendChild(div);var img=document.createElement('img');img.width=obj.canvas.width*obj.Get('chart.zoom.factor');img.height=obj.canvas.height*obj.Get('chart.zoom.factor');img.style.position='relative';img.style.backgroundColor='white';img.__object__=obj;div.appendChild(img);RGraph.Registry.Set('chart.zoomed.div',div);RGraph.Registry.Set('chart.zoomed.img',img);setTimeout("RGraph.Registry.Get('chart.zoomed.div').__object__.canvas.onmouseover()",5);}else{div=RGraph.Registry.Get('chart.zoomed.div');img=RGraph.Registry.Get('chart.zoomed.img');}
img.src=canvas.toDataURL();if(div&&div.style.opacity<1){setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.opacity = 1",400);}
var c=RGraph.getCanvasXY(obj.canvas);var x=c[0];var y=c[1];var offset=7;if(obj.Get('chart.zoom.thumbnail.fixed')){div.style.left=(x+obj.Get('chart.gutter.left')+5)+'px';div.style.top=(y+obj.Get('chart.gutter.top')+5)+'px';}else{div.style.left=(e.pageX-obj.Get('chart.zoom.thumbnail.width')-offset)+'px';div.style.top=(e.pageY-obj.Get('chart.zoom.thumbnail.height')-offset)+'px';}
var l=(obj.Get('chart.zoom.thumbnail.width')/2)-(coords[0]*obj.Get('chart.zoom.factor'));var t=(obj.Get('chart.zoom.thumbnail.height')/2)-(coords[1]*obj.Get('chart.zoom.factor'));img.style.left=(l+((obj.Get('chart.zoom.thumbnail.width')/2)*obj.Get('chart.zoom.factor')))+'px';img.style.top=(t+((obj.Get('chart.zoom.thumbnail.height')/2)*obj.Get('chart.zoom.factor')))+'px';if(obj.Get('chart.zoom.thumbnail.fixed')){img.style.left=(l+(obj.Get('chart.zoom.factor')))+'px';img.style.top=(t+(obj.Get('chart.zoom.factor')))+'px';}
RGraph.FireCustomEvent(obj,'onzoom');}
ZoomWindow_mouseover=function(e)
{var div=RGraph.Registry.Get('chart.zoomed.div');if(!div)return;if(div&&RGraph.Registry.Get('chart.zoomed.div').__object__.Get('chart.zoom.thumbnail.fixed')){return}
var obj=div.__object__;var targetWidth=obj.Get('chart.zoom.thumbnail.width');var targetHeight=obj.Get('chart.zoom.thumbnail.height');div.style.width=0;div.style.height=0;if(obj.Get('chart.zoom.fade.in')){RGraph.Registry.Get('chart.zoomed.div').style.opacity=0.2;setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.opacity = 0.1",25);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.opacity = 0.2",50);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.opacity = 0.3",75);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.opacity = 0.4",100);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.opacity = 0.5",125);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.opacity = 0.6",150);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.opacity = 0.7",175);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.opacity = 0.8",200);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.opacity = 0.9",225);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.opacity = 1.0",250);}else{setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.opacity = 1",1);}
setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.width = '"+(targetWidth*(1/10))+"px'",25);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.width = '"+(targetWidth*(2/10))+"px'",50);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.width = '"+(targetWidth*(3/10))+"px'",75);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.width = '"+(targetWidth*(4/10))+"px'",100);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.width = '"+(targetWidth*(5/10))+"px'",125);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.width = '"+(targetWidth*(6/10))+"px'",150);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.width = '"+(targetWidth*(7/10))+"px'",175);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.width = '"+(targetWidth*(8/10))+"px'",200);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.width = '"+(targetWidth*(9/10))+"px'",225);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.width = '"+(targetWidth*(10/10))+"px'",250);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.height = '"+(targetHeight*(1/10))+"px'",25);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.height = '"+(targetHeight*(2/10))+"px'",50);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.height = '"+(targetHeight*(3/10))+"px'",75);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.height = '"+(targetHeight*(4/10))+"px'",100);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.height = '"+(targetHeight*(5/10))+"px'",125);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.height = '"+(targetHeight*(6/10))+"px'",150);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.height = '"+(targetHeight*(7/10))+"px'",175);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.height = '"+(targetHeight*(8/10))+"px'",200);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.height = '"+(targetHeight*(9/10))+"px'",225);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.height = '"+(targetHeight*(10/10))+"px'",250);}
ZoomWindow_mouseout=function(e)
{var div=RGraph.Registry.Get('chart.zoomed.div');if(div&&div.__object__.Get('chart.zoom.fade.out')&&!div.__object__.Get('chart.zoom.thumbnail.fixed')){RGraph.Registry.Get('chart.zoomed.div').style.opacity=0.8;setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.opacity = 0.6",100);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.opacity = 0.4",200);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.opacity = 0.2",300);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.opacity = 0",400);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.left = '-400px'",400);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.top = '-400px'",400);}else if(!div.__object__.Get('chart.zoom.thumbnail.fixed')){if(RGraph.Registry.Get('chart.zoomed.div')){setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.left = '-400px'",1);setTimeout("RGraph.Registry.Get('chart.zoomed.div').style.top = '-400px'",41);}}}}
...
if(obj.Get('chart.zoom.shadow')){for(var i=1;i<=frames;++i){setTimeout("__zoomedimage__.style.boxShadow = 'rgba(128,128,128,"+Number(i/frames)/2+") 0 0 15px'",i*delay);setTimeout("__zoomedimage__.style.MozBoxShadow = 'rgba(128,128,128,"+Number(i/frames)/2+") 0 0 15px'",i*delay);setTimeout("__zoomedimage__.style.WebkitBoxShadow = 'rgba(128,128,128,"+Number(i/frames)/2+") 0 0 15px'",i*delay);}}
if(obj.Get('chart.zoom.background')){var div=document.createElement('DIV');div.style.backgroundColor='#999';div.style.opacity=0;div.style.position='fixed';div.style.top=0;div.style.left=0;div.style.width=(screen.width+100)+'px';div.style.height=(screen.height+100)+'px';div.style.zIndex=98;div.oncontextmenu=function(e)
{return RGraph.HideZoomedCanvas(e);}
div.origHeight=div.style.height;document.body.appendChild(div);__zoomedbackground__=div;for(var i=1;i<=frames;++i){setTimeout("__zoomedbackground__.style.opacity = "+(Number(i/frames)*0.5),i*(delay/2));}}
RGraph.FireCustomEvent(obj,'onzoom');}