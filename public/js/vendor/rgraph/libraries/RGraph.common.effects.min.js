...
div.style.position='relative';canvas.style.position='absolute';canvas.style.top=0;canvas.style.left=0;$('#'+obj.id).animate({width:(canvas.width*1.2)+'px',height:(canvas.height*1.2)+'px',left:(canvas.width*-0.1)+'px',top:(canvas.height*-0.1)+'px'},250,function()
{$('#'+obj.id).animate({opacity:0,width:0,height:0,left:(canvas.width*0.5)+'px',top:(canvas.height*0.5)+'px'},750)});if(typeof(arguments[2])=='function'){setTimeout(arguments[2],1000);}}
...
$('#'+div.id).animate({width:obj.canvas.width+'px'},opt['duration'],function(){RGraph.Effects.Line.Trace_callback(obj)});RGraph.Effects.Line.Trace_callback=function(obj)
...
{this.obj=obj;this.idx=idx;this.frames=15;this.curFrame=0;}
